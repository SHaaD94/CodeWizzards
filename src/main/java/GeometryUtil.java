...
class GeometryUtil {
    ...
    static Point getNextIterationPosition(double angle, double x, double y) {
        return GeometryUtil.rotateByAngle(angle, x + 4, y, x, y);
    }

    static Point getNextIterationPosition(double speedX, double angle, double x, double y) {
